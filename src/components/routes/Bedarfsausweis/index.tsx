            ...
            {/* <div className="col-grid">
              <div className="col-grid-items">
                <div className="icon-center-alignment">
                  <img
                    src={VerbrauchsausweisIcon}
                    alt="VerbrauchsausweisIcon"
                  />
                </div>
                ...
                <p>
                  ...
                  Energieausweis benötigen, haben wir für Sie zusammengestellt.
                  Alles parat? Dann starten Sie gleich mit der Erstellung.
                </p>
