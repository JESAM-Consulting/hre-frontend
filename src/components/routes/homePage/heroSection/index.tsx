        ...
        <div className="relative-main-div">
          <div className="hero-section">
            <div className="centered-text">
              ...
              <img src={Vector1Image} alt="Vector 1" className="vector1-image-style" />
              <img src={Vector1ImageMobile} alt="Vector 1" className="vector-mobile" />
              <div className="info-text">
                HRE Immobilien verkauft und vermietet Immobilien aller Assetklassen.<br></br>
                Unsere Expertise geht von Wohnungen, Einfamilien,- Doppel- und Reihenhäusern, über Villen, Wohn- und Geschäftshäusern bis hin zu Grundstücken und ganzen Neubauprojekten.
              </div >
              <NavLink to="/properties-page" className="offer-link">
    <img src={Frame1Image} alt="Frame 1" className="frame1-image-style" />
  
</NavLink>
<NavLink to="/kontakt">
    <img src={Picture2Image} alt="Picture 2" className="picture-style" />
</NavLink>
<a href="https://bewertung.hre-immobilien.de/" target="_blank" rel="noopener noreferrer">
    <img src={Frame3Image} alt="Picture 3" className="newpic-style" />
</a>
            </div>
            <div className="large-image-style">
            <img src={Bedroommobile} alt="Bedroom Mobile" className="bedroom-mobile-image" />
        ...
        <div className="tow-new-s-alignment">
          <div className="image-container">
            ...
            <div className="frame278-container">
                <img src={Frame278Image} alt="Frame 278" className="frame278-image-style" />
                <div className="frame278-text-content">
                <a href="tel:042138872470" style={{ textDecoration: 'none', color: 'inherit' }}>
        <strong>Telefon</strong> 0421/ 38 87 247-0
    </a>
    <br />
    <a href="mailto:info@hre-immobilien.de" style={{ textDecoration: 'none', color: 'inherit' }}>
