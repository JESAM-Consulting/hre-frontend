...
export default function PartnerSection() {
  return (
    <div>
      <div className="partner-all-content-section-alignment-new">
        <div className="grid">
          <div className="grid-items">
            <div className="card-image">
              <img src={ParnterImage02} alt="ParnterImage02" />
            </div>
            <div className="card-details-alignment">
              <div className="space">
                ...
                <div className="all-text-alignment-grid">
                  ...
                  <a href="mailto:lw@hre-immobilien.de?subject = Feedback&body = Message">
                    <div className="text-alignment">
                      <div
                        className="animate__slideInUp animate__animated wow"
                        data-wow-offset="100"
                      ...
                      <div
                        ...
                        data-wow-offset="100"
                      >
                        <span>lw@hre-immobilien.de</span>
                      </div>
                    </div>
                  </a>
                </div>
            ...
            <div className="card-details-alignment">
              <div className="space">
                ...
                <div className="all-text-alignment-grid">
                  ...
                  <a href="mailto: tp@hre-immobilien.de?subject = Feedback&body = Message">
                    <div className="text-alignment">
                      <div
                        className="animate__slideInUp animate__animated wow"
                        data-wow-offset="100"
                      ...
                      <div
                        ...
                        data-wow-offset="100"
                      >
                        <span> tp@hre-immobilien.de</span>
                      </div>
                    </div>
                  </a>
                </div>
